...
public class ModSounds {
    ...
    public static final SoundEvent TARDIS_DOORS_UNLOCK = Registration.registerSoundEvent("tardis_doors_unlock");
    public static final SoundEvent TARDIS_DOORS_LOCK = Registration.registerSoundEvent("tardis_doors_lock");
    public static final SoundEvent TARDIS_DOORS_CLOSE = Registration.registerSoundEvent("tardis_doors_close");
    public static final SoundEvent TARDIS_DOORS_WOODEN_CLOSE = Registration.registerSoundEvent("tardis_doors_wooden_close");
    ...
    public static final SoundEvent TARDIS_CONTROL_1 = Registration.registerSoundEvent("tardis_control_1");
    public static final SoundEvent TARDIS_CONTROL_2 = Registration.registerSoundEvent("tardis_control_2");
    public static final SoundEvent TARDIS_CONTROL_3 = Registration.registerSoundEvent("tardis_control_3");
    public static final SoundEvent TARDIS_CONTROL_4 = Registration.registerSoundEvent("tardis_control_4");
    public static final SoundEvent TARDIS_CONTROL_HANDBRAKE_ON = Registration.registerSoundEvent("tardis_control_handbrake_on");
    public static final SoundEvent TARDIS_CONTROL_HANDBRAKE_OFF = Registration.registerSoundEvent("tardis_control_handbrake_off");
    public static final SoundEvent TARDIS_CONTROL_RANDOMIZER = Registration.registerSoundEvent("tardis_control_randomizer");
    ...
    public static void playTardisDoorsUnlockSound(World world, BlockPos blockPos) {
        playSound(world, blockPos, TARDIS_DOORS_UNLOCK, 1.0F, 1.0F);
    }

    public static void playTardisDoorsLockSound(World world, BlockPos blockPos) {
        playSound(world, blockPos, TARDIS_DOORS_LOCK, 1.0F, 1.0F);
    }
    ...
    public static void playTardisDoorsCloseSound(World world, BlockPos blockPos, boolean isWooden) {
        playSound(world, blockPos, isWooden ? TARDIS_DOORS_WOODEN_CLOSE : TARDIS_DOORS_CLOSE, 1.0F, 1.0F);
    }
    ...
    public static void playTardisHandbrakeOnSound(World world, BlockPos blockPos) {
        playSound(world, blockPos, TARDIS_CONTROL_HANDBRAKE_ON, 1.0F, 1.0F);
    }

    public static void playTardisHandbrakeOffSound(World world, BlockPos blockPos) {
        playSound(world, blockPos, TARDIS_CONTROL_HANDBRAKE_OFF, 1.0F, 1.0F);
    }
