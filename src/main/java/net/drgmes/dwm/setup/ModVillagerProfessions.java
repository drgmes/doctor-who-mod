    ...
    public static void setup() {
        ENGINEER.setTradeOffers(ImmutableMap.of(
            ...
            new TradeOffers.Factory[]{
                new TradeOffers.SellItemFactory(ModItems.TARDIS_KEY_1.getItem(), 64, 1, 1, 10),
                new TradeOffers.SellItemFactory(ModItems.REPAIR_KIT.getItem(), 12, 1, 1, 2),
            },
            2,
            new TradeOffers.Factory[]{
                new TradeOffers.BuyForOneEmeraldFactory(Items.AMETHYST_SHARD, 1, 8, 4),
                new TradeOffers.BuyForOneEmeraldFactory(ModItems.TITANIUM_INGOT.getItem(), 1, 16, 2),
            },
            3,
            new TradeOffers.Factory[]{
            ...
            4,
            new TradeOffers.Factory[]{
                new TradeOffers.BuyForOneEmeraldFactory(Items.ECHO_SHARD, 1, 4, 10),
            }
        ));
    }
}
