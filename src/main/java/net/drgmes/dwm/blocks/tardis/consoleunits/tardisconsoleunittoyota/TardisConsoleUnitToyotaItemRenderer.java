...
public class TardisConsoleUnitToyotaItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    @Override
    public void render(ItemStack stack, ModelTransformation.Mode mode, MatrixStack matrixStack, VertexConsumerProvider buffer, int light, int overlay) {
        ...
        TardisConsoleUnitToyotaModel model = new TardisConsoleUnitToyotaModel(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(modelLayer));
