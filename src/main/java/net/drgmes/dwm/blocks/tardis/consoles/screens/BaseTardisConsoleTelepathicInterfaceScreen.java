...
public abstract class BaseTardisConsoleTelepathicInterfaceScreen extends BaseTardisConsoleScreen {
    protected static final int LINE_PADDING = 3;

    protected ButtonWidget acceptButton;
    protected ButtonWidget cancelButton;

    public BaseTardisConsoleTelepathicInterfaceScreen(Text title, BaseTardisConsoleBlockEntity tardisConsoleBlockEntity) {
