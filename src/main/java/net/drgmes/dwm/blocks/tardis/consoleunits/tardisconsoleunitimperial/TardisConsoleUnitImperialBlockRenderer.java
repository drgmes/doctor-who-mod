...
public class TardisConsoleUnitImperialBlockRenderer extends BaseTardisConsoleUnitBlockRenderer<TardisConsoleUnitImperialBlockEntity> {
    ...
    private void renderScreen(TardisConsoleUnitImperialBlockEntity tile, MatrixStack matrixStack, VertexConsumerProvider buffer, int light, int overlay, float rotateDegrees) {
    ...
    private void renderScreenPage1(TardisConsoleUnitImperialBlockEntity tile, MatrixStack matrixStack, VertexConsumerProvider buffer, int light, int overlay, TardisStateManager tardis) {
        String NONE = "-";
