...
public abstract class BaseTardisConsoleUnitBlockEntity extends BlockEntity {
    ...
    public void sendMonitorUpdatePacket(ServerWorld world) {
        PacketHelper.sendToClient(
            TardisConsoleUnitRemoteCallablePackets.class,
            "updateTardisConsoleUnitMonitorPage",
    ...
    public void sendControlsUpdatePacket(ServerWorld world) {
        PacketHelper.sendToClient(
            TardisConsoleUnitRemoteCallablePackets.class,
            "updateTardisConsoleUnitControlsStates",
            world.getWorldChunk(this.getPos()),
    ...
    public void sendScrewdriverSlotUpdatePacket(ServerWorld world) {
        if (this.screwdriverItemStack.isEmpty()) {
            PacketHelper.sendToClient(
                TardisConsoleUnitRemoteCallablePackets.class,
                "clearTardisConsoleUnitScrewdriverSlot",
                world.getWorldChunk(this.getPos()),
                this.getPos()
            );
        }
            ...
            PacketHelper.sendToClient(
                TardisConsoleUnitRemoteCallablePackets.class,
                "updateTardisConsoleUnitScrewdriverSlot",
                world.getWorldChunk(this.getPos()),
    ...
    public void sendTelepathicInterfaceLocationsOpenPacket(ServerPlayerEntity player) {
        PacketHelper.sendToClient(
            TardisConsoleUnitRemoteCallablePackets.class,
            "openTardisConsoleUnitTelepathicInterfaceLocations",
            player,
    ...
    public void sendTelepathicInterfaceMapBannersOpenPacket(ServerPlayerEntity player, MapState mapData) {
        PacketHelper.sendToClient(
            TardisConsoleUnitRemoteCallablePackets.class,
            "openTardisConsoleUnitTelepathicInterfaceMapBanners",
            player,
    ...
    private static NbtCompound createLocationsListFromRegistry(ServerWorld world) {
        ...
        list.addAll(getLocationsForRegistry(Registry.BIOME_KEY, TardisConsoleUnitTelepathicInterfaceLocationsScreen.EDataType.BIOME, world));
        list.addAll(getLocationsForRegistry(Registry.STRUCTURE_KEY, TardisConsoleUnitTelepathicInterfaceLocationsScreen.EDataType.STRUCTURE, world));
    ...
    private static <T> List<Map.Entry<Identifier, TardisConsoleUnitTelepathicInterfaceLocationsScreen.EDataType>> getLocationsForRegistry(RegistryKey<Registry<T>> registryKey, TardisConsoleUnitTelepathicInterfaceLocationsScreen.EDataType type, ServerWorld world) {
