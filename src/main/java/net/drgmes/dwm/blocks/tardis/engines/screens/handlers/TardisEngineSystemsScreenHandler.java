...
public class TardisEngineSystemsScreenHandler extends BaseInventoryScreenHandler {
    public TardisEngineSystemsScreenHandler(int i, PlayerInventory playerInventory) {
        this(i, playerInventory, new SimpleInventory(TardisStateManager.SYSTEM_COMPONENTS_CONTAINER_SIZE));
    }

    public TardisEngineSystemsScreenHandler(int inventoryId, PlayerInventory playerInventory, Inventory inventory) {
        super(ModInventories.TARDIS_ENGINE, inventoryId, playerInventory, inventory);
