...
public class TardisConsoleToyotaModel extends EntityModel<Entity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition platform_rotor_a = base.addOrReplaceChild("platform_rotor_a", CubeListBuilder.create().texOffs(129, 0).addBox(-2.5147F, -0.5F, -6.0F, 5.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(142, 29).addBox(-6.0F, -0.5F, -2.4853F, 12.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -22.5F, 0.0F));
        PartDefinition platform_rotor_a_3_r1 = platform_rotor_a.addOrReplaceChild("platform_rotor_a_3_r1", CubeListBuilder.create().texOffs(86, 150).addBox(-6.0F, -23.0F, -2.4853F, 12.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(129, 35).addBox(-2.5147F, -23.0F, -6.0F, 5.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 22.5F, 0.0F, 0.0F, -0.7854F, 0.0F));
