...
public class TitaniumStripedSkinWallColoredBlockBuilder extends BlockBuilder {
    ...
    public void registerBlockStateAndModel(BlockStateModelGenerator blockStateModelGenerator) {
        BlockStateHelper.createWallBlockStateAndModel(blockStateModelGenerator, this, ModBlocks.TITANIUM_SKIN, true);
        ModelHelper.createWallXYItemModel(blockStateModelGenerator, this.getTexture(), ModBlocks.TITANIUM_SKIN.getTexture(), DWM.getIdentifier("item/" + this.getName()));
    }
