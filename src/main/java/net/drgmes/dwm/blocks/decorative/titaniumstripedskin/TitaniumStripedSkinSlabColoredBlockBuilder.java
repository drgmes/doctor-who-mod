...
public class TitaniumStripedSkinSlabColoredBlockBuilder extends BlockBuilder {
    ...
    public TitaniumStripedSkinSlabColoredBlockBuilder(String name, Item dyeItem) {
        super(name, new SlabBlock(TitaniumStripedSkinColoredBlockBuilder.getBlockSettings()), ModCreativeTabs.DECORATIONS);
    ...
    public void registerBlockStateAndModel(BlockStateModelGenerator blockStateModelGenerator) {
        BlockStateHelper.createSlabBlockStateAndModelWithDouble(blockStateModelGenerator, this, ModBlocks.TITANIUM_SKIN);
    ...
    public void registerRecipe(ModRecipeProvider provider, Consumer<RecipeJsonProvider> exporter) {
        ShapedRecipeJsonBuilder.create(this.getBlock(), 6)
            ...
            .pattern("###")
            .criterion("has_item", RecipeProvider.conditionsFromItem(ModBlocks.TITANIUM_STRIPED_SKINS.blockBuilders.get(dyeItem).getBlock()))
            .offerTo(exporter);
    }
}
