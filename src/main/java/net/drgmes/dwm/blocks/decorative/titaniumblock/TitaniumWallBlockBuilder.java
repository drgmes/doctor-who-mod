...
public class TitaniumWallBlockBuilder extends BlockBuilder {
    ...
    public void registerBlockStateAndModel(BlockStateModelGenerator blockStateModelGenerator) {
        BlockStateHelper.createWallBlockStateAndModel(blockStateModelGenerator, this, ModBlocks.TITANIUM_BLOCK, false);
        ModelHelper.createWallItemModel(blockStateModelGenerator, ModBlocks.TITANIUM_BLOCK.getTexture(), DWM.getIdentifier("item/" + this.getName()));
    }
