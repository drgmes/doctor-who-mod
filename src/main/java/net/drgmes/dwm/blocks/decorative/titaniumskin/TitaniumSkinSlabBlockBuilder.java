...
public class TitaniumSkinSlabBlockBuilder extends BlockBuilder {
    public TitaniumSkinSlabBlockBuilder(String name) {
        super(name, new SlabBlock(TitaniumSkinBlockBuilder.getBlockSettings()), ModCreativeTabs.DECORATIONS);
    }
    ...
    public void registerBlockStateAndModel(BlockStateModelGenerator blockStateModelGenerator) {
        BlockStateHelper.createSlabBlockStateAndModel(blockStateModelGenerator, this, ModBlocks.TITANIUM_SKIN);
