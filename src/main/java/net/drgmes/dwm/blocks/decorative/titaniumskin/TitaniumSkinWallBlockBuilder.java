...
public class TitaniumSkinWallBlockBuilder extends BlockBuilder {
    public TitaniumSkinWallBlockBuilder(String name) {
        super(name, new WallBlock(TitaniumSkinBlockBuilder.getBlockSettings()), ModCreativeTabs.DECORATIONS);
    }
    ...
    public void registerBlockStateAndModel(BlockStateModelGenerator blockStateModelGenerator) {
        BlockStateHelper.createWallBlockStateAndModel(blockStateModelGenerator, this, ModBlocks.TITANIUM_SKIN, false);
        ModelHelper.createWallItemModel(blockStateModelGenerator, ModBlocks.TITANIUM_SKIN.getTexture(), DWM.getIdentifier("item/" + this.getName()));
    }
