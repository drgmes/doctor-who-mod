...
public class ScrewdriverInterfaceMainScreen extends BaseScrewdriverInterfaceScreen {
    ...
    protected void init() {
        ...
        this.modeButton = new ButtonWidget((int) modeButtonPos.x, (int) modeButtonPos.y, buttonWidth, BUTTON_HEIGHT, this.getModeButtonTitle(), (btn) -> {
    ...
    private void apply() {
        PacketHelper.sendToServer(
            ...
            this.screwdriverItemStack, this.isMainHand
        );
    }
}
