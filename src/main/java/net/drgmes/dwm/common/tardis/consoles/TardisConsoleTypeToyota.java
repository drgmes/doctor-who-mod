...
public class TardisConsoleTypeToyota extends TardisConsoleType {
    public TardisConsoleTypeToyota() {
        ...
        this.addControlEntry(TardisConsoleControlRoles.ENERGY_ARTRON_HARVESTING, TardisConsoleControlEntryTypes.BUTTON, new Vec3(-1.005F, 0.505F, -0.3585F), "controls/control_buttons/control_button_17$_r1", ModEntities.TARDIS_CONSOLE_CONTROL_SMALL);
        this.addControlEntry(TardisConsoleControlRoles.ENERGY_FORGE_HARVESTING, TardisConsoleControlEntryTypes.BUTTON, new Vec3(-1.005F, 0.505F, -0.295F), "controls/control_buttons/control_button_18$_r1", ModEntities.TARDIS_CONSOLE_CONTROL_SMALL);
