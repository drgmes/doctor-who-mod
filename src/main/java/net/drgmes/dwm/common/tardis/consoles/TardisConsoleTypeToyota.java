...
public class TardisConsoleTypeToyota extends TardisConsoleType {
    public TardisConsoleTypeToyota() {
        ...
        this.addControlEntry(TardisConsoleControlRoles.RESET, TardisConsoleControlEntryTypes.BUTTON, new Vec3(0.4825F, 0.6F, -0.25F), "controls/control_button_20", ModEntities.TARDIS_CONSOLE_CONTROL_SMALL);
