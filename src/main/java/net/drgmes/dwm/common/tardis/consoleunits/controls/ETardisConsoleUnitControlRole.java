...
public enum ETardisConsoleUnitControlRole {
    ...
    FUEL_HARVESTING(ETardisConsoleUnitControlRoleType.BOOLEAN, "message." + DWM.MODID + ".tardis.control.role.fuel", 0, ModSounds.TARDIS_CONTROL_2),
    ENERGY_HARVESTING(ETardisConsoleUnitControlRoleType.BOOLEAN, "message." + DWM.MODID + ".tardis.control.role.energy", 0, ModSounds.TARDIS_CONTROL_2),
