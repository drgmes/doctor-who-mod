...
public class TardisConsoleUnitTypeEntryToyota extends TardisConsoleUnitTypeEntry {
    public TardisConsoleUnitTypeEntryToyota(String name) {
        super(name);
        ...
        this.addControlEntry(ETardisConsoleUnitControlRole.ENERGY_ARTRON_HARVESTING, ETardisConsoleUnitControlEntry.BUTTON, new Vec3d(-1.005F, 0.505F, -0.3585F), "controls/control_buttons/control_button_17$_r1", ModEntities.TARDIS_CONSOLE_UNIT_CONTROL_SMALL);
        this.addControlEntry(ETardisConsoleUnitControlRole.ENERGY_FORGE_HARVESTING, ETardisConsoleUnitControlEntry.BUTTON, new Vec3d(-1.005F, 0.505F, -0.295F), "controls/control_buttons/control_button_18$_r1", ModEntities.TARDIS_CONSOLE_UNIT_CONTROL_SMALL);
