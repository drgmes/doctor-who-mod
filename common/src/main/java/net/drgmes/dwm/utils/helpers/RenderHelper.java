...
public class RenderHelper {
    ...
    public static void drawImage(DrawContext context, Vector2i pos, Vector2i size, Identifier image) {
        context.drawTexture(image, pos.x, pos.y, 0, 0, size.x, size.y, size.x, size.y);
    }
    ...
    public static ButtonWidget getButtonWidget(Vector2i pos, int width, int height, Text message, ButtonWidget.PressAction onPress) {
        return getButtonWidget(pos.x, pos.y, width, height, message, onPress);
    }
}
