...
public class ModVillagerProfessions {
    ...
    public static final VillagerProfessionBuilder SHOBOGAN_ENGINEER = new VillagerProfessionBuilder(
        ...
        (profession) -> {
            ...
            TradeRegistry.registerVillagerTrade(
                profession, 3,
                new SimpleTrade(new ItemStack(Items.EMERALD, 48), ItemStack.EMPTY, new ItemStack(ModItems.SCREWDRIVER_11.getItem()), 1, 60, 1),
                new SimpleTrade(new ItemStack(Items.EMERALD, 48), ItemStack.EMPTY, new ItemStack(ModItems.SCREWDRIVER_12.getItem()), 1, 60, 1),
                new SimpleTrade(new ItemStack(Items.EMERALD, 48), ItemStack.EMPTY, new ItemStack(ModItems.SCREWDRIVER_13.getItem()), 1, 60, 1)
            );

            TradeRegistry.registerVillagerTrade(
                profession, 4,
                new SimpleTrade(new ItemStack(Items.ECHO_SHARD), ItemStack.EMPTY, new ItemStack(Items.EMERALD, 6), 4, 10, 1)
            );
        }
    );
