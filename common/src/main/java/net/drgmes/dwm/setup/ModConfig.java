            ...
            builder.push("CommonSettings");
            {
                builder.push("TARDIS");
                {
                    dimensionsBlacklist = builder
                        ...
                        .translation("config.dwm.option.dimensionsBlacklist.@Tooltip")
                    ...
                    hideTheEndConditionally = builder
                        ...
                        .translation("config.dwm.option.hideTheEndConditionally.@Tooltip")
                    ...
                    tardisFlightDistanceRate = builder
                        ...
                        .translation("config.dwm.option.tardisFlightDistanceRate.@Tooltip")
                    ...
                    tardisMaxFlightTime = builder
                        ...
                        .translation("config.dwm.option.tardisMaxFlightTime.@Tooltip")
                    ...
                    tardisFuelRefillTiming = builder
                        ...
                        .translation("config.dwm.option.tardisFuelRefillTiming.@Tooltip")
                    ...
                    tardisFuelConsumeTiming = builder
                        ...
                        .translation("config.dwm.option.tardisFuelConsumeTiming.@Tooltip")
                    ...
                    tardisFuelToEnergyRating = builder
                        ...
                        .translation("config.dwm.option.tardisFuelToEnergyRating.@Tooltip")
