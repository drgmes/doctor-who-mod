...
public class TardisConsoleUnitSoundPacket extends BaseC2SMessage {
    ...
    public void handle(NetworkManager.PacketContext context) {
        ...
        if (player.getWorld().getBlockEntity(this.blockPos) instanceof BaseTardisConsoleUnitBlockEntity) {
            ModSounds.playTardisConsoleCrackSound(player.getWorld(), this.blockPos);
        }
    }
}
