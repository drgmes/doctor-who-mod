...
public class TitaniumPickaxeItemBuilder extends ItemBuilder {
    public TitaniumPickaxeItemBuilder(String name) {
        super(name, () -> new PickaxeItem(
            ModMaterials.ToolMaterial.TITANIUM,
            getItemSettings().attributeModifiers(PickaxeItem.createAttributeModifiers(ModMaterials.ToolMaterial.TITANIUM, 1.0F, -2.8F))
        ));
    }
