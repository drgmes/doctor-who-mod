...
public enum ETardisConsoleUnitControlRole {
    ...
    SHIELDS_OXYGEN(ETardisConsoleUnitControlRoleType.BOOLEAN, "shields_oxygen", 0, ModSounds.TARDIS_CONTROL_2),
    SHIELDS_FIRE_PROOF(ETardisConsoleUnitControlRoleType.BOOLEAN, "shields_fire_proof", 0, ModSounds.TARDIS_CONTROL_2),
    SHIELDS_MEDICAL(ETardisConsoleUnitControlRoleType.BOOLEAN, "shields_medical", 0, ModSounds.TARDIS_CONTROL_2),
    SHIELDS_MINING(ETardisConsoleUnitControlRoleType.BOOLEAN, "shields_mining", 0, ModSounds.TARDIS_CONTROL_2),
    SHIELDS_GRAVITATION(ETardisConsoleUnitControlRoleType.BOOLEAN, "shields_gravitation", 0, ModSounds.TARDIS_CONTROL_2),
    SHIELDS_SPECIAL(ETardisConsoleUnitControlRoleType.BOOLEAN, "shields_special", 0, ModSounds.TARDIS_CONTROL_2),
