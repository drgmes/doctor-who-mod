...
public enum ETardisConsoleUnitControlRole {
    ...
    FUEL_HARVESTING(ETardisConsoleUnitControlRoleType.BOOLEAN, "fuel", 0, ModSounds.TARDIS_CONTROL_2, Set.of(ETardisConsoleUnitControlRoleFlags.REQUIRED_FLIGHT_SYSTEM, ETardisConsoleUnitControlRoleFlags.MUST_BE_LANDED)),
    ENERGY_HARVESTING(ETardisConsoleUnitControlRoleType.BOOLEAN, "energy", 0, ModSounds.TARDIS_CONTROL_2, Set.of(ETardisConsoleUnitControlRoleFlags.REQUIRED_FLIGHT_SYSTEM, ETardisConsoleUnitControlRoleFlags.MUST_BE_LANDED)),
