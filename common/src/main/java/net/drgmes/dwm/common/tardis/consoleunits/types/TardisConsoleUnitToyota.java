...
public class TardisConsoleUnitToyota extends TardisConsoleUnitEntry {
    public TardisConsoleUnitToyota() {
        super("toyota", () -> ModBlockEntities.TARDIS_CONSOLE_UNIT_TOYOTA);
