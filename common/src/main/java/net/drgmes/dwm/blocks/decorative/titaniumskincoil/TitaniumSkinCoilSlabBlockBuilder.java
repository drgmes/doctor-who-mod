...
public class TitaniumSkinCoilSlabBlockBuilder extends BlockBuilder {
    public TitaniumSkinCoilSlabBlockBuilder(String name) {
        super(name, () -> new SlabBlock(TitaniumSkinCoilBlockBuilder.getBlockSettings()));
    }
    ...
    public BlockModelDataBuilder getBlockModelDataBuilder() {
        return new BlockModelDataBuilder(this, BlockModelDataBuilder.BlockType.SOLID_SLAB, BlockModelDataBuilder.ItemType.PARENTED)
            .addBlockTexture(TextureKey.ALL, ModBlocks.TITANIUM_SKIN_COIL.getTexture())
            .addBlockTexture(TextureKey.CONTENT, ModBlocks.TITANIUM_SKIN_COIL.getId());
    }
    ...
    public void registerRecipe(Consumer<RecipeJsonProvider> exporter) {
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, this.getBlock(), 6)
            ...
            .pattern("###")
            .criterion("has_item", RecipeHelper.conditionsFromItem(ModBlocks.TITANIUM_SKIN_COIL.getBlock()))
            .offerTo(exporter);
    }
}
